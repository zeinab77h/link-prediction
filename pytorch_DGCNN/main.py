...
from lib.diffpool import DiffPool, extract_elementary_subgraph_features


class Classifier(nn.Module):
    def __init__(self, regression=False, use_diffpool=False):  # new edit: Add use_diffpool
        ...
        if cmd_args.gm == 'DGCNN':
            self.gnn = model(latent_dim=cmd_args.latent_dim,
                             ...
                             use_diffpool=use_diffpool)  # new edit: Pass use_diffpool
...
if __name__ == '__main__':
    ...
    classifier = Classifier(use_diffpool=True)  # new edit: Enable DiffPool
